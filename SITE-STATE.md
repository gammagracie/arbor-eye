...
- **Footer**: 43px tall, growing to 54px between 1280px and 1920px (15% shorter than the earlier 50–64px). One line: copyright left, Instagram (links to instagram.com/arbor.eye, new tab) and Pinterest icons right; on very narrow phones the copyright wraps to two lines with "Arbor & Eye" kept together on the second, and stays vertically centred on the icons. Sits at the end of the page (not sticky).
