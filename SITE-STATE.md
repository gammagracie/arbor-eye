...
- **Previous / next chevrons** sit either side of the work (the same thin light-grey chevrons as the home carousel, darker on hover; 13 x 36px, 10 x 28px on phones), hugging the work with a fixed gap and vertically centred on it. Click or tap steps to the previous / next work in the line-up, wrapping round at either end, and glides that work's thumbnail to the centre of the strip. The work leaves room for them (56px each side, 24px on phones).
